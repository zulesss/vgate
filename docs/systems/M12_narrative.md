...
(Первое предложение «КИНЕТИКА — 3D-арена, где остановка убивает» убрано 2026-05-04 — было дублирующим. Остальной capsule text также используется как подсказка-tutorial на death screen — единый источник правды.)
