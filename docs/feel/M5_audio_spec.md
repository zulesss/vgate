...
> **2026-04-29:** pitch shift убран — артефакт на текущем ассете dash_whoosh.ogg
> (юзер слышал "тиканье/шуршание" во время даша). Ассет играется на pitch_scale=1.0.
> Feel-эффект "вырывание из удушения = выше и острее" не доставлен. Следующий
> аудио-pass: либо чистить ассет (resample/trim hi-freq), либо менять подход
> (другой sfx-файл, не pitch-shift). См. autoload/sfx.gd._on_dash_started.
